            ...
            <div className="w-[97%] mx-auto mt-3">
                <form action="" className="w-[60%] mx-auto ">
                    ...
                    <div className="flex items-center justify-between mt-6 ">
                        ...
                        <input type="text" id="billName" name="billName" className="bg-gray-200 rounded-sm w-[80%] ml-4 py-2 px-2 focus:outline-2 text-sm focus:outline-primary-color" placeholder="bill name here" />
                    </div>
                    ...
                    <div className="flex items-center mt-6 justify-between ">
                        ...
                        <select name="category" id="category" className="w-[80%] bg-gray-200 py-2 px-2 text-sm rounded-sm">
                    ...
                    <div className="flex items-center justify-between mt-6 ">
                        ...
                        <input type="date" id="dueDate" name="dueDate" className="bg-gray-200 rounded-sm w- w-[80%] ml-4 py-2 px-2 focus:outline-2  focus:outline-primary-color text-sm" />
                    </div>
                    {/** Amount */}
                    <div className="flex items-center justify-between mt-6 ">
                        <label htmlFor="amount" aria-label="amount" className="text-sm text-gray-600 font-noraml">Amount</label>
                        <input type="text" id="amount" name="amount" className="bg-gray-200 rounded-sm w- w-[80%] ml-4 py-2 px-2 focus:outline-2  focus:outline-primary-color text-sm" placeholder="Rs." />
                    </div>
                    {/** Fine to pay */}
                    <div className="flex items-center justify-between mt-6 ">
                    ...
                    <div className="flex justify-center mt-10">
                        <Button className="bg-primary-color px-4 py-1 rounded text-sm font-medium text-snow hover:cursor-pointer hover:bg-[#4044B9] w-[8rem]">Add</Button>
                    </div>
                </form>
            </div>
        </div>
